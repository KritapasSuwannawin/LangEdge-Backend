...
export class Migration1755631463123 implements MigrationInterface {
  name = 'Migration1755631463123';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "translation" ADD CONSTRAINT "UQ_f68c0af907f8a6183b1f9e5fe02" UNIQUE ("input_text", "input_language_id", "output_language_id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "example_sentence" ADD CONSTRAINT "UQ_67f6a9b491af9eb7299a288b0ec" UNIQUE ("text", "language_id", "output_language_id")`,
    );
    await queryRunner.query(`ALTER TABLE "synonym" ADD CONSTRAINT "UQ_fcff5abcd9706165ac485036aa0" UNIQUE ("text", "language_id")`);
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "FK_a1ca2711002397dfd73dc3ee86b" FOREIGN KEY ("last_used_language_id") REFERENCES "language"("id") ON DELETE SET NULL ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "translation" ADD CONSTRAINT "FK_9f6e923c9269ef723ab9465d9fa" FOREIGN KEY ("input_language_id") REFERENCES "language"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "translation" ADD CONSTRAINT "FK_8537ea9c853f0429c0e9ae2644c" FOREIGN KEY ("output_language_id") REFERENCES "language"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "example_sentence" ADD CONSTRAINT "FK_cb19c3a8d5ef4f0ff4febbdf1ed" FOREIGN KEY ("language_id") REFERENCES "language"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "example_sentence" ADD CONSTRAINT "FK_f030332de458ed02e5496f94b43" FOREIGN KEY ("output_language_id") REFERENCES "language"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "synonym" ADD CONSTRAINT "FK_a3edbc0d7a7af33955cfd602835" FOREIGN KEY ("language_id") REFERENCES "language"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "example_sentence" ADD CONSTRAINT "example_sentence_text_language_id_output_language_id_key" UNIQUE ("text", "language_id", "output_language_id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "translation" ADD CONSTRAINT "translation_input_text_input_language_id_output_language_id_key" UNIQUE ("input_text", "input_language_id", "output_language_id")`,
    );
